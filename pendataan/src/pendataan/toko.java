...
public class toko {
    ...
    toko(String namaBrg, String satuan, int stokAwal, int stokMasuk, int stokKeluar, int hargaBeli, int hargaJual, long noKodeBrg){
    ...
    public ArrayList<toko> getBrgList() {
        return BrgList;
    }
    ...
    toko Brg;
    ArrayList<toko> BrgList = new ArrayList<>();
        ...
        while(ulang){
            ...
            if (strHargaJual.equals("0")){
                ...
                try{
                    ...
                    Brg = new toko(namaBrg, satuan, stokAwal, stokMasuk, stokKeluar, hargaBeli, hargaJual, noKodeBrg); // OBJEK ke - 1
                    BrgList.add(Brg);
    ...
    public ArrayList<toko> ubahBarang(ArrayList<toko> Brglist) {
        int ubah;
        System.out.println("\nMengubah Data Barang Bangunan\n");
        for (int i=0; i<BrgList.size(); i++){
    ...
    public void hapusBarang() {
        ...
        System.out.println("\n>> Barang Bangunan Berhasil di Hapus <<\n");
    }
